    ...
    <section className="py-20 flex flex-col justify-center items-center text-center gap-8 bg-zinc-900/50 rounded-3xl p-8 md:p-16 my-12 relative overflow-hidden border border-zinc-800 shadow-2xl" id="contact">
      ...
      <div className="max-w-2xl relative z-10">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4">
          <a href="https://github.com/PrajwalChaple" target="_blank" rel="noreferrer" className="px-6 py-3 sm:px-8 sm:py-4 rounded-lg border border-zinc-800 bg-zinc-950 flex items-center justify-center gap-3 hover:border-cyan-400/50 hover:text-cyan-400 transition-colors font-mono text-base sm:text-lg">
            <Github size={22} className="text-zinc-400 group-hover:text-cyan-400" />
            github.com
          </a>
          <a 
            href="https://mail.google.com/mail/?view=cm&to=prajwalchaple14@gmail.com" 
            target="_blank" 
            rel="noreferrer" 
            className="px-6 py-3 sm:px-10 sm:py-4 rounded-lg bg-cyan-400 text-zinc-950 font-medium hover:bg-cyan-300 transition-colors flex items-center justify-center gap-3 text-base sm:text-lg font-mono"
          >
            <Mail size={22} />
            send_email()
          </a>
