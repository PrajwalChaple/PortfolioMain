        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-zinc-400 font-mono">
              <li><Link to="/service/frontend" className="hover:text-cyan-400 transition-colors">&gt; Frontend Dev</Link></li>
              <li><Link to="/service/fullstack" className="hover:text-cyan-400 transition-colors">&gt; Full-Stack Apps</Link></li>
              <li><Link to="/service/ai-integration" className="hover:text-cyan-400 transition-colors">&gt; AI Integration</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-zinc-400 font-mono">
              ...
              <li><a href="https://mail.google.com/mail/?view=cm&to=prajwalchaple14@gmail.com" target="_blank" rel="noreferrer" className="hover:text-cyan-400 transition-colors">&gt; Email</a></li>
            </ul>
          </div>
